...
//                     <input type="password" onChange = {onChangePassword} className="form-control" id="Password"/>
//                 </div>
    ...
    let submitHandler = (e)=>{    
        ...
        async function checkLogin(){    
            // post to the backend, the email and password
                ...
                console.log('*************************');
                console.log(email,pass)   ;
            let response = await axios.post(process.env.REACT_APP_LINKTOBACKEND+'login',{email,pass});
